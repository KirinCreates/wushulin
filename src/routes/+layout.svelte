...
<div>
    <img class="m-4 md:w-64 mx-auto" alt="The project logo" src={logo} />
    <div class="flex justify-center md:text-lg lg:text-xl">
        <nav class="flex flex-wrap justify-center items-center my-1">
