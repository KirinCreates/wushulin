<div class="md:w-[48rem] md:mx-auto md:text-lg lg:text-xl">
    <h1 class="text-3xl font-bold my-4 md:my-6 mx-1">Att nå ut</h1>
    <p class="my-4 md:my-6 mx-1"><em>Datum skrivet: 2024-09-08</em></p>
    <p class="my-4 md:my-6 mx-1">
        Veckan som gått samt video på stavträning:
    </p>
    ...
    <p class="my-4 md:my-6 mx-1">
        ...
        är mer intresserade av att se anpassade flöden för dem i deras mobiler. Tror att det är bättre om man försöker nå ut med reklam på nätet till kamsportsintresserade.
